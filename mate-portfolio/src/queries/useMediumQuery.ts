...
// //   const posts = allFeedMediumFeed.nodes.map(
// //     (p: { title: any; contentSnippet: any; link: any; pubDate: any }) => ({
// //       title: p.title,
...
// export const useMediumQuery = (): { posts: MediumPost[] } => {
...
//   const posts = allFeedMediumFeed.nodes.map((p: any) => ({
//     title: p.title,
//     text: p.contentSnippet,
//     url: p.link,
//     date: p.pubDate,
